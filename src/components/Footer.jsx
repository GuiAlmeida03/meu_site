    ...
    <footer id="contact" className="relative overflow-hidden border-t border-white/5">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pt-20 pb-10">
        <div className="text-center mb-16 reveal">
          <span className="section-label justify-center mb-4"><span className="text-purple-400">—</span>{tr.sectionLabel}</span>
          ...
          <p className="font-body text-slate-400 text-lg max-w-lg mx-auto mb-10">{tr.subtitle}</p>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-slate-600 text-xs font-mono">
          <div className="flex items-center gap-2"><Cpu size={12} className="text-purple-500" /><span>Guilherme Henrique Costa de Almeida</span></div>
          <div className="flex items-center gap-1.5"><span>{tr.madeWith}</span><Heart size={10} className="text-purple-500 fill-purple-500" /><span>React + Vite + Tailwind</span></div>
