...
const content = {
  pt: {
    ...
    items: [
      ...
      { type: 'education', icon: GraduationCap,year: '2024', period: '2024 — Presente', title: 'Ciência de Dados',             subtitle: 'UFMS — Graduação Tecnológica', desc: 'Graduação com ênfase em estatística, análise preditiva, visualização de dados e fundamentos matemáticos para ciência de dados.',                                          tags: ['Estatística', 'Python', 'Análise Preditiva'] },
    ],
  },
  en: {
    ...
    items: [
      ...
      { type: 'education', icon: GraduationCap,year: '2024', period: '2024 — Present',  title: 'Data Science',                 subtitle: 'UFMS — Technology Degree',     desc: 'Degree with emphasis on statistics, predictive analytics, data visualization and mathematical foundations for data science.',                                           tags: ['Statistics', 'Python', 'Predictive Analytics'] },
    ],
  },
}
