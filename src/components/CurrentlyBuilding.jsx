import { Hammer, BookOpen, Zap, ArrowRight } from 'lucide-react'
    ...
    items: [
      {
        ...
        description: 'Este próprio site — iterando constantemente com novas features, animações e conteúdo atualizado.',
      ...
      },
      {
        ...
        description: 'Explorando orquestração de Large Language Models e construção de agentes com memória e ferramentas.',
      ...
      },
      {
        icon: Zap,
        type: 'Estudo',
        title: 'MLOps & Deploy de Modelos',
        description: 'Aprendendo pipelines de deploy de modelos de ML em produção com Docker, FastAPI e monitoramento.',
    ...
    items: [
      {
        ...
        description: 'This very site — constantly iterating with new features, animations and updated content.',
        tags: ['React', 'Vite', 'Tailwind'],
        progress: 85,
        color: 'text-purple-400',
        bg: 'bg-purple-500/10 border-purple-500/25',
      ...
      },
      {
        ...
        type: 'Study',
        title: 'LangChain & LLMs',
        description: 'Exploring Large Language Model orchestration and building agents with memory and tools.',
        tags: ['Python', 'LangChain', 'OpenAI API'],
        progress: 45,
        color: 'text-blue-400',
        bg: 'bg-blue-500/10 border-blue-500/25',
      ...
      },
      {
        ...
        description: 'Learning ML model deployment pipelines in production with Docker, FastAPI and monitoring.',
        tags: ['Docker', 'FastAPI', 'MLflow'],
        progress: 30,
        color: 'text-cyan-400',
        bg: 'bg-cyan-500/10 border-cyan-500/25',
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <div className="mb-16 reveal">
          <span className="section-label">
            ...
            {tr.sectionLabel}
            {/* Pulsing dot to indicate live/active */}
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {tr.items.map((item, i) => {
            ...
            return (
              <div
                key={item.title}
                className={`card-glow reveal reveal-delay-${i + 1} group relative flex flex-col rounded-2xl border ${item.bg} p-6 transition-all duration-300 hover:-translate-y-2 overflow-hidden`}
              >
                {/* Animated top bar */}
                <div className={`absolute top-0 left-0 h-0.5 bg-gradient-to-r ${item.bar} transition-all duration-700`}
                ...
                {/* Title */}
                <h3 className="font-display font-bold text-base text-white leading-snug mb-3">
                  {item.title}
                </h3>
                ...
                <div className="flex flex-wrap gap-2 mb-5">
                  {item.tags.map(tag => (
                    <span key={tag} className="text-xs font-mono px-2.5 py-1 rounded-md bg-white/4 border border-white/8 text-slate-400">
                      {tag}
                    </span>
                  ))}
                </div>
                ...
                <div>
                  ...
                  <div className="h-1.5 rounded-full bg-white/5 overflow-hidden">
                    <div
                      className={`h-full rounded-full bg-gradient-to-r ${item.bar} transition-all duration-1000`}
                      style={{ width: `${item.progress}%` }}
                    />
                  </div>
                </div>
